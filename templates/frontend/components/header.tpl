...
<header class="site-header">
    ...
    <nav class="user-nav">
            {if $requestedPage|escape != "article"}
            <div class="roy"><a href="{$baseUrl}"><span class="home fa fa-home"></span></a></div>
                ...
                <div class="col-lg-12">
                    <form class="input-group" action="{url page="search" op="search"}" method="post" role="search">
                        ...
                        <input type="text" name="query" value="{$searchQuery|escape}" class="search-input-tag form-control"
                               placeholder="{translate key="plugins.roy.search-text"}" aria-label="Search">
                        <span class="input-group-btn">
                            <button class="btn btn-secondary"
                                    type="submit">{translate key="plugins.roy.search"}</button>
                        </span>
                    </form>
                </div>
            </div>
